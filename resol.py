...
def format_message_pv1(msg):
    parsed = "PARSED: \n"
    parsed += "    ZIEL.........: " + get_destination(msg) + "\n"
    parsed += "    QUELLE.......: " + get_source(msg) + " " + get_source_name(msg) + "\n"
    parsed += "    PROTOKOLL....: " + get_protocolversion(msg) + "\n"
    parsed += "    BEFEHL.......: " + get_command(msg) + "\n"
    parsed += "    ANZ_FRAMES...: " + str(get_frame_count(msg)) + "\n"
    parsed += "    CHECKSUM.....: " + format_byte(msg[8]) + "\n"
    for i in range(get_frame_count(msg)):
        integrated = integrate_septett(msg[9+(i*6):15+(i*6)])
        parsed += "    NB"+str(i*4+1)+"..........: " + format_byte(msg[9+(i*6)]) + " " + format_byte(integrated[0]) + "\n"
        parsed += "    NB"+str(i*4+2)+"..........: " + format_byte(msg[10+(i*6)]) + " " + format_byte(integrated[1]) + "\n"
        parsed += "    NB"+str(i*4+3)+"..........: " + format_byte(msg[11+(i*6)]) + " " + format_byte(integrated[2]) + "\n"
        parsed += "    NB"+str(i*4+4)+"..........: " + format_byte(msg[12+(i*6)]) + " " + format_byte(integrated[3]) + "\n"
        parsed += "    SEPTETT"+str(i+1)+"......: " + format_byte(msg[13+(i*6)]) + "\n"
        parsed += "    CHECKSUM"+str(i+1)+".....: " + format_byte(msg[14+(i*6)]) + "\n"
    parsed += "    PAYLOAD... ...: " + (" ".join(format_byte(b) for b in get_payload(msg)))+"\n"
...
def format_message_pv2(msg):
    parsed = "PARSED: \n"
    parsed += "    ZIEL1........: " + format_byte(msg[0:1]) + "\n"
    parsed += "    ZIEL2........: " + format_byte(msg[1:2]) + "\n"
    parsed += "    QUELLE1......: " + format_byte(msg[2:3]) + "\n"
    parsed += "    QUELLE2......: " + format_byte(msg[3:4]) + "\n"
    parsed += "    PROTOKOLL....: " + format_byte(msg[4:5]) + "\n"
    parsed += "    BEFEHL1......: " + format_byte(msg[5:6]) + "\n"
    parsed += "    BEFEHL2......: " + format_byte(msg[6:7]) + "\n"
    parsed += "    ID1..........: " + format_byte(msg[7:8]) + "\n"
    parsed += "    ID2..........: " + format_byte(msg[8:9]) + "\n"
    parsed += "    WERT1........: " + format_byte(msg[9:10]) + "\n"
    parsed += "    WERT2........: " + format_byte(msg[10:11]) + "\n"
    parsed += "    WERT3........: " + format_byte(msg[11:12]) + "\n"
    parsed += "    WERT4........: " + format_byte(msg[12:13]) + "\n"
    parsed += "    SEPTETT......: " + format_byte(msg[13:14]) + "\n"
    parsed += "    CHECKSUM.....: " + format_byte(msg[14:15]) + "\n"
